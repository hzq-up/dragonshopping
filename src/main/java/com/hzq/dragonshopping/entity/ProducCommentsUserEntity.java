 ...
 * 商品详情评论详情
 */
public class ProducCommentsUserEntity {
    ...
    public ProducCommentsUserEntity(Integer comments_id, String comments_centent, Integer comments_user_id, Integer comments_produce_id, Integer comments_stars, String comments_date, UserEntity userEntity, ProduceEntity produceEntity) {
        this.comments_id = comments_id;
        this.comments_centent = comments_centent;
        this.comments_user_id = comments_user_id;
        this.comments_produce_id = comments_produce_id;
    ...
    public ProducCommentsUserEntity() {
        super();
    }
}
